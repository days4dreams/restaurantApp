...
<section class="block-list">
  ...
  <ul>
    <li>
      <div>
        <p class="list-header"> <img src="http://lorempixel.com/30/30/animals" class="" height="" width="" alt="">A SINGLE LINE BLOCK</p> </div>
    </li>
    <li>
      <div>
      ...
      <div>
        <img src="http://lorempixel.com/30/30/animals" class="" height="" width="" alt="">
      </div>
    </li>
    <li>
      <div>
